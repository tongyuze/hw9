...
public class CustomListAdapter extends ArrayAdapter<JSONObject>
{
    ...
    public CustomListAdapter(Context context, int resource, ArrayList<JSONObject> items) {
    ...
    public View getView(int position,View view,ViewGroup parent) {
        ...
        try {
            String src = item.getJSONObject("picture").getJSONObject("data").getString("url");
